...
// Se configura carpeta public como publica, según lo pedido en requerimientos
app.use(express.static(__dirname + "/public"));

// Se define la ruta a carpeta pública de los archivos
...
app.get('/cargar', async (req, res) => {
    ...
    try {
        ...
        res.sendFile(__dirname + '/' + newname); //devuelve el archivo procesado al cliente, y en el directorio raíz se crea con el nuevo nombre asignado
        ...
        res.status(500).send('Ups! Debe haber algún error, recomendamos revisar bien la ruta. El sistema dice: ' + error.message); // muestra el mensaje personalizado de error de línea 52 y 55
        // res.status(500).send('Ups! La ruta debe tener algún error...  inténtelo de nuevo');  // no muestra el mensaje de error personalizado de los casos anteriores y en todos los casos sólo se muestra este mensaje
